...
class FairseqModel(BaseFairseqModel):
    ...
    def forward(self, src_tokens, src_lengths, prev_output_tokens, lang_pair):
        """
        ...
        """
        encoder_out = self.encoder(src_tokens, src_lengths, lang_pair)
...
class FairseqMultiModel(BaseFairseqModel):
    ...
    def __init__(self, encoders, decoders):
        ...
        self.keys = list(encoders.keys())   # lang-pairs
